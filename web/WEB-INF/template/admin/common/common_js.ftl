<script src="${base}/resources/admin/jquery/jquery-1.12.4.min.js" type="text/javascript"></script>
<script src="${base}/resources/admin/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${base}/resources/admin/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
