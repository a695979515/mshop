                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="${base}/resources/admin/layout/img/avatar2.jpg"
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="${base}/resources/admin/layout/img/avatar3.jpg"
                                                         class="img-circle" alt=""> </span>
                                                <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                    <img src="${base}/resources/admin/layout/img/avatar1.jpg"
                                                         class="img-circle" alt=""> </span>
                                                <span class="subject">
