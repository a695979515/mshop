...
<@html.html title="添加物流公司" bar=message("Admin.menu.system.logisticsCompany") bar_title="添加物流公司信息">
<div class="row">
    <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control"name="url"  maxlength="200" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">代码</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="code"  maxlength="20" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
