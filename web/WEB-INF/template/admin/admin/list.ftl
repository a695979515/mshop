                    ...
                    <div class="input-group input-medium" >
                        <div class="input-group-btn">
                            ...
                            <ul class="dropdown-menu" id="searchPropertyOption">
                                <li>
                                    <a href="javascript:;"<#if page.searchProperty == "username"> class="active"</#if> val="username">用户名</a>
                                </li>
                                <li>
                                    <a href="javascript:;"<#if page.searchProperty == "email"> class="active"</#if> val="email">邮件</a>
                                </li>
                                <li>
                                    <a href="javascript:;"<#if page.searchProperty == "name"> class="active"</#if> val="name">名字</a>
                                </li>
                            </ul>
                        </div><!-- /btn-group -->
                        ...
                        <div class="input-group-btn">
                            <button type="submit" class="btn btn-default " id="searchPropertySelect">&nbsp;<span class="glyphicon glyphicon-search"></span>&nbsp;</button>
